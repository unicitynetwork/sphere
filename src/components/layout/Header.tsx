      ...
      <div className="max-w-[1800px] mx-auto px-8 h-20 flex items-center justify-between relative z-10">
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            <div className="flex items-center gap-2">
              <h1 className="text-xl text-neutral-900 dark:text-white bg-clip-text">AgentSphere</h1>
              <Sparkles className="w-4 h-4 text-orange-500 animate-pulse" />
              {isMock() && (
                <span className="px-2 py-0.5 rounded-full text-xs bg-yellow-500/20 text-yellow-600 dark:text-yellow-400 border border-yellow-500/30">
                  DEMO
                </span>
              )}
            </div>
            <p className="text-xs text-neutral-500 dark:text-neutral-400">AI-Powered Agent Platform</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <motion.button
            ...
            className="relative p-3 hover:bg-neutral-100 dark:hover:bg-neutral-800/80 rounded-xl transition-all group"
          >
            <Bell className="w-5 h-5 text-neutral-500 dark:text-neutral-400 group-hover:text-orange-400 transition-colors" />
          ...
          <motion.button
            ...
            className="relative p-3 hover:bg-neutral-100 dark:hover:bg-neutral-800/80 rounded-xl transition-all group"
          >
            <Settings className="w-5 h-5 text-neutral-500 dark:text-neutral-400 group-hover:text-orange-400 transition-colors" />
            <div className="absolute inset-0 rounded-xl bg-orange-500/0 group-hover:bg-orange-500/10 transition-colors" />
          </motion.button>
