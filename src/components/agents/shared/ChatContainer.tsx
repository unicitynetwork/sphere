...
export function ChatContainer({
  ...
  return (
    <div className="bg-linear-to-br from-neutral-900/60 to-neutral-800/40 backdrop-blur-xl rounded-3xl border border-neutral-800/50 overflow-hidden grid grid-rows-1 relative shadow-2xl h-full min-h-0">
