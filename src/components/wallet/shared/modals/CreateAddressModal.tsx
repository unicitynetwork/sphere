...
// Step: Deriving address - matches onboarding ProcessingScreen design
function StepDeriving() {
  return (
    ...
    >
      {/* Animated Loading Spinner - matching onboarding style */}
...
// Step: Processing - matches onboarding ProcessingScreen design
function StepProcessing({ step, progress }: { step: CreateAddressStep; progress: string }) {
  ...
  // Determine step indicators state
