...
const PANEL_SHELL = "bg-white/60 dark:bg-neutral-900/90 backdrop-blur-xl rounded-none border-0 lg:border-l lg:border-neutral-200 dark:lg:border-neutral-800/50 overflow-hidden h-full relative lg:shadow-none flex flex-col transition-all duration-500 theme-transition";
