import{r as m,j as e,m as n,L as o}from"./index-PDMXN2ck.js";function h(){const[t,x]=m.useState("init"),[l,c]=m.useState(null),i=(r,s)=>{navigator.clipboard.writeText(r),c(s),setTimeout(()=>c(null),2e3)},a={init:{icon:"🔑",title:"Initialization",tagline:"Your key is your identity.",description:"Provider-based architecture. Your BIP39 mnemonic IS your identity. Auto-creates or loads existing wallets.",color:"from-emerald-500 to-teal-500",code:"const { sphere } = await Sphere.init({ ...providers, mnemonic: '...' });",fullExample:`import { Sphere } from '@unicitylabs/sphere-sdk';
